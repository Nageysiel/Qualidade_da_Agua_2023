...
parametro_extenso <- "Índice de Qualiade da Água"
...
Os dados utilizados no cálculo do IQA foram fornecidos pelas redes de monitoramento operadas por órgãos gestores de recursos hídricos das Unidades da Federação. A quantidade de pontos de monitoramento da qualidade da água nas Unidades da Federação (UFs) varia bastante no Brasil. A produção de informações hidrológicas, como as de qualidade da água, é fundamental a gestão dos recursos hídricos. 
...
O mapa abaixo mostra a localização dos pontos de monitoramento com valores de IQA. `r paste("Ao clicar nos pontos, o mapa interativo traz informações sobre o início e fim da série e o número de observações de ", parametro_abreviado, " no período analisado", sep="")`.
...
Médias de IQA para os pontos de monitoramento com, pelo menos, **10 observações no período**. No mapa abaixo, as cores indicam faixas de qualidade que variam entre **péssima (0-19), ruim (19-36), regular (36-51), boa (51-79) e ótima (79_100)**.`
