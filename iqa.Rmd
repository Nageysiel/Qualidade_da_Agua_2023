...
O IQA é um indicador composto por nove parâmetros físicos, químicos e biológicos, a saber: temperatura da água, pH, oxigênio dissolvido, demanda bioquímica de oxigênio, coliformes termotolerantes, nitrogênio total, fósforo total, sólidos totais e turbidez. A maior vantagem da utilização do IQA é a análise simultânea de diversos parâmetros considerados importantes para a avaliação geral da qualidade da água em um único resultado, que varia de zero a 100. Esses valores costumam ser agrupados em faixas de cores com a indicação da qualidade da água entre péssima e ótima. Os valores de 0 a 100 e a escala de cores auxiliam a comunicação da qualidade da água para a população de uma forma geral, traduzindo questões técnicas para uma linguagem simples e visual.
...
pal = colorRampPalette(c('cyan', 'navy'))
