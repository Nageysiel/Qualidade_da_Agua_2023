...
summary1 %>%
  kbl(digits = 2, format = "html", caption = "Estatísticas de PT (mg/L)", font_size = 16, booktabs = TRUE, col.names = c("Mín.", "Quartil 1","Mediana","Média","Quartil 3","Máx." ) ) %>%
  kable_styling("striped", full_width = T, position = "left", font_size = 14) 
