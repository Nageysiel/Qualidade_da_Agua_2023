...
**A DBO representa a o consumo de oxigênio na água por microorganismos que degradam a matéria orgânica**. É, portanto, um indicador da poluição da água por cargas orgânicas. Esgotos domésticos não tratados são ricos em matéria orgânica. 
...
#pal <-  mapviewPalette("mapviewSpectralColors")
pal = colorRampPalette(c('pale golden rod', 'dark olive green'))
...
`r paste("De acordo com os padrões do enquadramento de corpos hídricos, **a concentração máxima de ", parametro_abreviado, " para águas de Classe 1 é 3 mg/L; para Classe 2 é 5 mg/L e para a Classe 3 é 10 mg/L. (Res. CONAMA, 2005)**", sep="")`. 
