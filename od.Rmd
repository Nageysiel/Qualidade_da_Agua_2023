...
O mapa abaixo mostra a localização dos pontos de monitoramento com ocncentrações de OD. `r paste("Ao clicar nos pontos, o mapa interativo traz informações sobre o início e fim da série e o número de observações de ", parametro_abreviado, " no período analisado", sep="")`.
